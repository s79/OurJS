...
var createScrollbar=function(config)
{
	...
	function keyDown(event)
	{
		...
		if(keyCode==32)
		{
			...
			w2sDirect($box.scrollTop+vH);
		}
		else if(keyCode==33)w2sDirect($box.scrollTop-vH);	//Page Up
		else if(keyCode==34)w2sDirect($box.scrollTop+vH);	//Page Down
		else if(keyCode==36)w2sDirect($box.scrollTop-sH);	//Home
		else if(keyCode==35)w2sDirect($box.scrollTop+sH);	//End
...
*/
	...
	var $bar=$("<div>");
	$bar.className="bar";
	$bar.innerHTML="<div class='bar_m'><div class='bar_t'></div><div class='bar_b'></div></div>";
	var $bottom=$("<div>");
	$bottom.className="button_b";
