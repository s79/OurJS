...
//--------------------------------------------------[Paginator]
   ...
   * @attribute data-endpoint-pages
   *   在导航条的两端最多可以显示的“导航链接”数量。
   *   如果不指定本属性，则使用 1 作为默认值。
   * @attribute data-adjacent-pages
   ...
   *   </ul>
   *   <strong>启用方式：</strong>
   *   为一个元素添加 'widget-paginator' 类，即可使该元素成为“分页导航条”。
   *   <strong>结构约定：</strong>
   ...
   *   点击“导航链接”时，会根据 data-target-url 的配置执行相应的操作。<br>如果没有指定 data-target-url，则在“导航链接”上发生的 click 事件的默认行为将被阻止。
   *   如果“上一页”或“下一页”处于禁用状态，将为其添加类名 'disabled'。
   *   <strong>默认样式：</strong>
   *   <pre class="lang-css">
   *   .widget-paginator { visibility: hidden; font-size: 14px; line-height: 16px; text-align: center; }
   *   .widget-paginator a:link, .widget-paginator a:visited, .widget-paginator a:hover, .widget-paginator a:active { display: inline-block; margin: 2px; padding: 2px 5px; border: 1px solid silver; background-color: white; color: black; text-decoration: none; }
   *   .widget-paginator a:hover { border-color: gray; background-color: gainsboro; }
   *   .widget-paginator a:active { border-color: dimgray; background-color: silver; }
   *   .widget-paginator a.current:link, .widget-paginator a.current:visited, .widget-paginator a.current:hover, .widget-paginator a.current:active { border-color: black; background-color: steelblue; color: white; }
   *   .widget-paginator a.disabled:link, .widget-paginator a.disabled:visited, .widget-paginator a.disabled:hover, .widget-paginator a.disabled:active { border-color: gainsboro; background-color: white; color: gainsboro; cursor: default; }
   *   </pre>
   */
