...
//--------------------------------------------------[Slideshow]
   ...
   *   <strong>结构约定：</strong>
   *   <ul>
   *     <li>“幻灯片播放器”的后代元素中，类名包含 'slides' 的为“幻灯片”的容器，类名包含 'slide' 的为“幻灯片”，类名包含 'pointers' 的为“指示器”的容器，类名包含 'pointer' 的为“指示器”，类名包含 'prev' 的为“播放上一张”按钮，类名包含 'next' 的为“播放下一张”按钮。<br>上述内容中，只有“幻灯片”和“幻灯片”的容器是必选的，其他均可以省略。如果“幻灯片”小于两个，则即便有“指示器”、“播放上一张”和“播放下一张”按钮，它们也将不可见。</li>
   *     <li>所有“幻灯片”都应有共同的父元素，并且它们的渲染尺寸也应与其父元素的渲染尺寸一致。</li>
   *     <li>如果需要“指示器”，则所有“指示器”也应有共同的父元素，它们的数量也应和“幻灯片”的数量一致。</li>
   *   </ul>
   *   <strong>新增行为：</strong>
   *   <ul>
   *     <li>当前播放的“幻灯片”和“指示器”（如果有）会被加入 'active' 类。</li>
